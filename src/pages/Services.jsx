  ...
  const services = [
    {
      ...
      description: 'Comprehensive multi-point inspection by certified technicians',
      icon: (
    ...
    },
    {
      ...
      description: 'Comprehensive coverage options for your vehicle',
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="bg-gray-50 rounded-lg p-12 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Thorough inspection by our experts</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Final inspection and delivery</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-600 rounded-lg p-12 text-center">
          ...
          <p className="text-xl text-white mb-8">
            Book your service appointment today and experience our premium care
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-white text-blue-600 rounded-full font-semibold hover:bg-gray-100"
          >
            Schedule Service
          </motion.button>
        </div>
